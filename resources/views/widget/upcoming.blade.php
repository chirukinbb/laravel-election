...
@section('body')
    <div class="wrapper">
        @if($election->date_start && $election->isUpcoming())
            <div id="countdown-container" class="text-center mb-4">
                <div class="countdown-timer p-3 rounded">
                    <h5 class="mb-2" style="font-weight: 500;">Election Starts In:</h5>
...
<svg width="25px" height="25px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" class="svg2">
  <rect x="2" y="2" width="12" height="12"
    ...
    <script>
        ...
        @if($election->date_start && $election->isUpcoming())
        (function () {
            const startDate = new Date('{{ $election->date_start->format("Y-m-d") }} 00:00:00').getTime();
            ...
            function updateCountdown() {
                ...
                if (distance < 0) {
                    $('#countdown-container').html('<div class="alert alert-success text-center">Election has started!</div>');
                    return;
                }
